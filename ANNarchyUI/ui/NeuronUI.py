...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuDefine = QtGui.QMenu(self.menuBar)
        self.menuDefine.setObjectName(_fromUtf8("menuDefine"))
        ...
        self.actionNew_Neuron = QtGui.QAction(MainWindow)
        self.actionNew_Neuron.setObjectName(_fromUtf8("actionNew_Neuron"))
        self.actionSynapse = QtGui.QAction(MainWindow)
        self.actionSynapse.setObjectName(_fromUtf8("actionSynapse"))
        self.actionNew_Neuron_2 = QtGui.QAction(MainWindow)
        self.actionNew_Neuron_2.setObjectName(_fromUtf8("actionNew_Neuron_2"))
        self.actionNew_Synapse = QtGui.QAction(MainWindow)
        self.actionNew_Synapse.setObjectName(_fromUtf8("actionNew_Synapse"))
        ...
        self.menuSave.addSeparator()
        self.menuDefine.addAction(self.actionNew_Neuron_2)
        self.menuDefine.addAction(self.actionNew_Synapse)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuDefine.setTitle(_translate("MainWindow", "Define", None))
        ...
        self.actionNew_Neuron.setText(_translate("MainWindow", "Neuron", None))
        self.actionSynapse.setText(_translate("MainWindow", "Synapse", None))
        self.actionNew_Neuron_2.setText(_translate("MainWindow", "new Neuron", None))
        self.actionNew_Synapse.setText(_translate("MainWindow", "new Synapse", None))
