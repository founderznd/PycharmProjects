...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox_connectivity = QtGui.QComboBox(Form)
        self.comboBox_connectivity.setObjectName(_fromUtf8("comboBox_connectivity"))
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        ...
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        self.comboBox_connectivity.addItem(_fromUtf8(""))
        self.verticalLayout.addWidget(self.comboBox_connectivity)
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_synapse_type.setItemText(1, _translate("Form", "Oja", None))
        ...
        self.comboBox_connectivity.setItemText(4, _translate("Form", "connect_fixed_number_pre", None))
        self.comboBox_connectivity.setItemText(5, _translate("Form", "connect_fixed_probability", None))
        self.comboBox_connectivity.setItemText(6, _translate("Form", "connect_from_file", None))
        self.comboBox_connectivity.setItemText(7, _translate("Form", "connect_from_matrix", None))
        self.comboBox_connectivity.setItemText(8, _translate("Form", "connect_from_sparse", None))
        self.comboBox_connectivity.setItemText(9, _translate("Form", "connect_gaussian", None))
        self.comboBox_connectivity.setItemText(10, _translate("Form", "connect_one_to_one", None))
        self.comboBox_connectivity.setItemText(11, _translate("Form", "connect_with_func", None))
