...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_neuron_type = QtGui.QComboBox(Dialog)
        self.comboBox_neuron_type.setObjectName(_fromUtf8("comboBox_neuron_type"))
        self.horizontalLayout_2.addWidget(self.comboBox_neuron_type)
        ...
        self.plainTextEdit_parameters = QtGui.QPlainTextEdit(self.tab_4)
        self.plainTextEdit_parameters.setObjectName(_fromUtf8("plainTextEdit_parameters"))
        self.verticalLayout_4.addWidget(self.plainTextEdit_parameters)
        self.label_12 = QtGui.QLabel(self.tab_4)
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.verticalLayout_4.addWidget(self.label_12)
        self.plainTextEdit_rates = QtGui.QPlainTextEdit(self.tab_4)
        self.plainTextEdit_rates.setObjectName(_fromUtf8("plainTextEdit_rates"))
        self.verticalLayout_4.addWidget(self.plainTextEdit_rates)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "Neuron Type:", None))
        ...
        self.label_11.setText(_translate("Dialog", "the parameters and rates are actually the members of population, so they should be save and read from population", None))
        self.label_13.setText(_translate("Dialog", "parameters:", None))
        self.label_12.setText(_translate("Dialog", "rates:", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("Dialog", "special neuron", None))
