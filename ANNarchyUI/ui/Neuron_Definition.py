...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.spike, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.parameter, 2, 0, 1, 1)
        self.equation = QtGui.QTextEdit(Dialog)
        self.equation.setObjectName(_fromUtf8("equation"))
        self.gridLayout.addWidget(self.equation, 2, 1, 1, 1)
        ...
        self.neurontype = QtGui.QLineEdit(Dialog)
        self.neurontype.setObjectName(_fromUtf8("neurontype"))
        self.gridLayout.addWidget(self.neurontype, 0, 1, 1, 1)
